        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Careers_Departments_DepartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompatibilityPercentage = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestResults_Careers_CareerId",
                        column: x => x.CareerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CareerScores", x => new { x.QuestionId, x.CareerId });
                    table.ForeignKey(
                        name: "FK_CareerScores_Careers_CareerId",
                        column: x => x.CareerId,
                        principalTable: "Careers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CareerScores_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Careers_DepartmentId",
                table: "Careers",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_CareerScores_CareerId",
                table: "CareerScores",
                column: "CareerId");
